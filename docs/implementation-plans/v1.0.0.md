...
### 成果物
- [ ] ルート`package.json`（Bun workspaces設定）
- [ ] `.gitignore`
- [ ] ディレクトリ構造
...
1. **設定ファイルの作成**
   ...
   - 2025年のカレンダーを設定（isLatest: true）
   - 過去年分のカレンダーを設定（isLatest: false）
...
### 成果物
- [ ] `apps/workers/data-collection/wrangler.toml`
- [ ] `apps/workers/data-collection/src/index.ts`
- [ ] `apps/workers/data-collection/src/utils/qiita.ts`
- [ ] `apps/workers/data-collection/src/utils/embedding.ts`
- [ ] `apps/workers/data-collection/src/utils/vectorize.ts`
...
### 成果物
- [ ] `apps/workers/search/wrangler.toml`
- [ ] `apps/workers/search/src/index.ts`
