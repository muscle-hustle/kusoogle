...
- [x] Cloudflare Pages用のwrangler.toml作成
- [x] デプロイガイドドキュメントの作成
- [x] Cloudflare Workersのデプロイ完了
...
または、Cloudflare DashboardからGitHubリポジトリを接続して自動デプロイを設定することもできます。

#### 5. 環境変数の設定

**Cloudflare Pages**:
- `NEXT_PUBLIC_SEARCH_API_URL`: Search API WorkerのURL
...
- フロントエンド: Cloudflare PagesのURLにアクセス
